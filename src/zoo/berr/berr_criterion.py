...
from .berr_utils import bbox2distance
...
class SetCriterion(nn.Module):
    ...
    def loss_boxes(self, outputs, targets, indices, num_boxes, **kwargs):
        ...
        loss_bbox_unweighted = F.l1_loss(pred_boxes, target_boxes, reduction="none")  # shape: [N, 4]
        loss_giou_unweighted = 1 - torch.diag(
            generalized_box_iou(
    ...
    def forward(self, outputs, targets, **kwargs):
        ...
        # In case of cdn auxiliary losses. For BERR
